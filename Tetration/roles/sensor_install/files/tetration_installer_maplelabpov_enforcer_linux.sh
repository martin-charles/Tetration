...
ACTIVATION_KEY=4924b8e886f803b97822d0230e9fca1d92deef88
...
EOF
  ...
  if [ -z $UUID_FILE ] ; then
    ...
    check_host_version
    [ $? -ne 0 ] && log "Error: Unsupported platform $DISTRO-$VERSION" && return 1
  fi
  ...
  API_KEY=14f1e5862b8c46bf97ae7ba301e8b891
  API_SECRET=39ebe68752b2a537eabbbf86dea72eb9a76938e4
  ARCH=$(uname -m)
